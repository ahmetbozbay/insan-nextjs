...
const generateSpacingValues = (start: number, end: number, step: number) => {
...
const config: Config = {
  ...
  content: [
    "./src/dictionaries/**/*.{js,ts,jsx,tsx,mdx,json}",
    "./src/pages/**/*.{js,ts,jsx,tsx,mdx}",
    "./src/components/**/*.{js,ts,jsx,tsx,mdx}",
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "breadcrumb-bg": "linear-gradient(90deg, #03562E 27.6%, rgba(171, 185, 183, 0.13) 72.4%)",
        "breadcrumb-bg-light": "linear-gradient(90deg, #03562E 27.6%, rgb(83, 137, 129) 72.4%)",
        "breadcrumb-rtl-bg": "linear-gradient(270deg, #03562E 27.6%, rgba(171, 185, 183, 0.13) 72.4%)",
        "breadcrumb-rtl-bg-light": "linear-gradient(270deg, #03562E 27.6%, rgb(83, 137, 129) 72.4%)",
      },
      colors: {
        'primary': '#03562E',
      ...
      spacing: generateSpacingValues(1, 1000, 1),
      fontSize: {
        xxs: "0.625rem", // 10px
        xs: "0.6875rem", // 11px
        sm: "0.75rem", // 12px
  ...
  plugins: [
    ...
    plugin(({ addComponents, matchUtilities, theme }) => {
      matchUtilities(
        ...
        {
          // Specify what kind of values this utility can accept
      ...
      addComponents({
        ".container": {
          ...
          margin: "auto",
          padding: "0px 12px",
          "@screen xs-to-min": { maxWidth: "540px" },
          "@screen xs-to-sm-min": { maxWidth: "720px" },
          "@screen xs-to-md-min": { maxWidth: "960px" },
          "@screen xs-to-lg-min": { maxWidth: "1140px" },
          "@screen xs-to-xl-min": { maxWidth: "1320px" },
        },
      });
    }),
  ],

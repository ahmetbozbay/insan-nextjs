...
export const metadata = {
  title: "Mısır Kurban Bağışı 2026 | Vekaletle Kurban Kesimi",
  description: "2026 Mısır kurban bağışı hisse bedelini inceleyin. Vekaletle kurban kesimi, İslami usullere uygun dağıtım ve video raporlama süreci.",
  alternates: {
...
const KurbanDonationPage = () => {
  ...
  return (
    <main className="bg-white">
      ...
      <section className="relative w-full h-[500px] lg:h-[720px] overflow-hidden bg-white">
          ...
          <div className="absolute inset-0">
            <Image
              ...
              alt="2026 vekaletle Mısır kurban bağışı ve Mısır'da kurban eti dağıtım organizasyonu"
              fill
              priority
              sizes="100vw"
            ...
            <div className="flex flex-col justify-center h-full max-w-[780px]">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-[#e31e24] font-bold tracking-[0.25em] text-xs uppercase">
                  2026 Mısır Kurban Organizasyonu
                </span>
              </div>

              {/* H1 (PRIMARY SEO KEYWORD) */}
              <h1 className="text-[#0b5331] text-4xl md:text-6xl font-extrabold leading-[1.1] mb-6">
                Mısır Kurban Bağışı 2026<br />
              </h1>

              {/* SEO DESCRIPTION (LSI keywords included) */}
              <p className="text-gray-700 text-lg md:text-xl leading-relaxed mb-10 max-w-[680px]">
                <strong>Mısır kurban bağışı</strong> ile 2026 yılı kurban ibadetinizi vekalet yoluyla gerçekleştirerek 
                <strong> Mısır’daki ihtiyaç sahiplerine</strong> ulaştırılmasını sağlayabilirsiniz.
              </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div className="sticky top-24">
              <DonationPaymentSection
                categories={["Mısır", "Vekalet"]}
                paymentMethods={[]}
                quickSelectAmounts={[15000]}
                donationTitle="Mısır Kurban Bağışı"
                href="/tr/pay/qurbani"
                donationDetailsImage="/assets/images-used/projects/mısır.webp"
                donationDescription="Mısır bölgesi kurban bağışı. Hisse bedeli: 15.000 TL"
                initialAmount={15000}
              />
            </div>
        </div>
      ...
      {/* --- ZENGİN SEO İÇERİK: Mısır KURBAN BAĞIŞI DETAYLARI --- */}
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="w-full lg:w-2/3">
              ...
              <div className="prose prose-lg text-gray-600 space-y-8 max-w-none">
                <p>
                  <strong>Mısır kurban bağışı</strong>, 2026 Kurban Bayramı’nda ihtiyaç sahiplerine ulaşmanın en etkili yollarından biridir. İnsan Derneği olarak, 
                  <strong>vekaletle kurban kesimi</strong> süreçlerini Mısır’daki yerel ekiplerimizle birlikte şeffaf ve İslami usullere uygun şekilde yürütüyoruz.
                </p>

                <h3 className="text-2xl font-bold text-gray-800">Mısır'da Kurban Kesimi ve Şeffaflık Standartlarımız</h3>
                <p>
                  ...
                  Mısır kurban hisse bedelleri belirlenirken yerel üreticilerin desteklenmesi ve etin ihtiyaç sahiplerine en hızlı şekilde ulaştırılması esas alınır.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-12">
                  ...
                  <div className="bg-[#f8f9fa] p-8 rounded-2xl border-l-4 border-[#0b5331]">
                    ...
                    <p className="text-l leading-relaxed">
                      Kurban etleri hijyenik koşullarda hazırlanır ve Mısır’daki ihtiyaç sahiplerine hızlı şekilde ulaştırılır.
                    </p>
                  </div>
                </div>

                <h3 className="text-2xl font-bold text-gray-800">Mısır Kurban Hisse Bedeli 2026</h3>
                <p>
                  <strong>Mısır kurban fiyatları</strong>, bölgedeki ekonomik koşullar dikkate alınarak belirlenmiştir. Küçükbaş kurban bağışı veya hisse seçenekleri ile 2026 Kurban Bayramı’nda Mısır’daki ihtiyaç sahiplerine destek olabilirsiniz. Yapılan tüm bağışlar İnsan Derneği güvencesiyle titizlikle gerçekleştirilir.
                </p>
              </div>
            </div>
              ...
              <div className="bg-[#fcfcfc] rounded-3xl p-8 border border-gray-100 shadow-sm">
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex justify-between items-center pb-3 border-b border-gray-100">
                    ...
                    <span className="font-bold text-gray-900">Mısır</span>
                  </div>
        ...
        <div className="container mx-auto px-6 text-center lg:text-left">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-600 text-lg">
              Mısır kurban bağışı süreci hakkında merak edilen teknik ve dini detaylar.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto grid gap-5">
            {[
              {
                q: "Mısır kurban bağışı vekaleti nasıl verilir?",
              ...
              {
                q: "Mısır’da kurban kesimi güvenli mi?",
                a: "Kurban organizasyonlarımız Mısır’daki yerel ekipler ve güvenli kesim noktaları üzerinden yürütülmektedir. Tüm süreçler İslami şartlara uygun ve kontrollü şekilde gerçekleştirilir."
              },
              {
                q: "Kurban etleri nasıl dağıtılıyor?",
                a: "Kesilen kurban etleri hijyenik şekilde paketlenir ve Mısır’daki ihtiyaç sahibi ailelere yerel ekipler aracılığıyla doğrudan ulaştırılır."
              },
              {
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntity": [
                {
                  "@type": "Question",
                  "name": "Mısır kurban bağışı vekaleti nasıl verilir?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                ...
                {
                  "@type": "Question",
                  "name": "Mısır’da kurban kesimi güvenli mi?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Kurban kesimleri Mısır’daki yerel ekipler ve güvenli kesim noktaları üzerinden, İslami usullere uygun şekilde gerçekleştirilmektedir."
                  }
                },
                {
                  "@type": "Question",
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Etler hijyenik şekilde paketlenir ve Mısır’daki ihtiyaç sahibi ailelere yerel ekipler aracılığıyla ulaştırılır."
                  }
                },
                {
                  "@type": "Question",

    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/70 backdrop-blur-sm px-4">
      ...
      <div className="relative w-full max-w-2xl">
        ...
        <button
          ...
          className="absolute -top-6 -right-6 z-20 bg-white text-gray-900 w-28 h-28 rounded-full flex items-center justify-center shadow-2xl hover:bg-emerald-600 hover:text-white transition-all"
        >
          <X size={140} strokeWidth={2.5} />
        </button>

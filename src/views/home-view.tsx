        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex flex-col gap-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {/* Telefon Kartı */}
                    <a href="tel:+905010879198" className="flex items-center gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:border-emerald-500/30 hover:bg-white transition-all group">
